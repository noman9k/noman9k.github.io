          ...
          children: [
            PageView(
              ...
              children: [
                ...
                Page(index: 1, pageController: pageController),
                Page(index: 2, pageController: pageController),
                Page(index: 3, pageController: pageController),
...
class _StackImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned.fill(
      child: ClipPath(
        clipper: percentageMoved > 0
            ? WaveClipper(percentageMoved.toDouble())
            : null,
        child: Image.asset(
          'assets/${index + 4}.jpg',
...
class Page extends StatelessWidget {
  ...
  const Page({Key? key, required this.index, required this.pageController})
      : super(key: key);
